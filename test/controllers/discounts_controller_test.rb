...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { description: @discount.description, percentage: @discount.percentage, restaurant_id: @discount.restaurant_id, title: @discount.title }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { description: @discount.description, percentage: @discount.percentage, restaurant_id: @discount.restaurant_id, title: @discount.title }
    assert_redirected_to discount_path(assigns(:discount))
  end
